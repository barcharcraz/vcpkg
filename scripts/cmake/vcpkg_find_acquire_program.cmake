function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "BISON")
    set(PROGNAME bison)
    set(PATHS ${DOWNLOADS}/tools/bison)
    set(URL "https://sourceforge.mirrorservice.org/g/gn/gnuwin32/bison/2.4.1/bison-2.4.1-bin.zip")
    set(ARCHIVE "bison-2.4.1-bin.zip")
    set(HASH ea8556c2be1497db96c84d627a63f9a9021423041d81210776836776f1783a91f47ac42d15c46510718d44f14653a2e066834fe3f3dbf901c3cdc98288d0b845)
  elseif(VAR MATCHES "FLEX")
    set(PROGNAME "FLEX")
    set(PATHS ${DOWNLOADS}/tools/flex)
    set(URL "https://sourceforge.mirrorservice.org/g/gn/gnuwin32/flex/2.5.4a-1/flex-2.5.4a-1-bin.zip")
    set(ARCHIVE "flex-2.5.4a-1-bin.zip")
    set(HASH da33b1bf2ac617fcac4e73eeff4d36cc0a7ad7cb093355a11f6abcffd60684d1edeb6f198cc6e6f91d831ba49dc93196c7c5d0684e42a0ad234fc891cca72081)
  else()
