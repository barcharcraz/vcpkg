function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "MSGFMT")
    set(PROGNAME msgfmt)
    set(PATHS ${DOWNLOADS}/tools/msgfmt/bin)
    set(URL "https://github.com/mlocati/gettext-iconv-windows/releases/download/v0.19.8.1-v1.14/gettext0.19.8.1-iconv1.14-static-32.zip")
    set(ARCHIVE "gettext0.19.8.1-iconv1.14-static-32.zip")
    set(HASH 2f8899a32949addceb70b2c0bb4b970c8afe1b9ce7f4c2bde211fe764e191b943623003c6a9199039ac2fcca15780d587dbdef194a9af0393048b992af0b59be)
  elseif(VAR MATCHES MSGMERGE)
  ...
  elseif(VAR MATCHES FLEX)
    ...
    set(URL "http://downloads.sourceforge.net/project/winflexbison/win_flex_bison-2.5.6.zip?r=https%3A%2F%2Fsourceforge.net%2Fprojects%2Fwinflexbison%2Ffiles%2Fwin_flex_bison-2.5.6.zip%2Fdownload&ts=1480231576&use_mirror=kent")
    set(ARCHIVE "win_flex_bison-2.5.6.zip")
    set(HASH d17731360daf6b08c4245124a9133a4a53e944b0116a9eff0cb9971bc5954ec0d81067b218a9a73e1420cdbb34a579569b55a0e60f559e4646005159dabe4e02)
